...
- Update to work with ponyc 0.72.1 ([PR #180](https://github.com/ponylang/stallion/pull/180))

## [0.13.0] - 2026-09-11

### Changed

- Update to work with ponyc 0.72.0 ([PR #178](https://github.com/ponylang/stallion/pull/178))

## [0.12.0] - 2026-09-07

### Changed

- SSLContext now comes from lori instead of ponylang/ssl ([PR #177](https://github.com/ponylang/stallion/pull/177))

## [0.11.0] - 2026-09-04

### Changed

- Update to work with ponyc 0.70.0 ([PR #174](https://github.com/ponylang/stallion/pull/174))
...
- Require ponyc 0.64.0 or later ([PR #111](https://github.com/ponylang/stallion/pull/111))
