...
class \nodoc\ iso _TestParseCookieKnownGood is UnitTest
  ...
  fun _test_multiple_cookies(h: TestHelper) =>
    ...
    h.assert_eq[String val](
      "1",
      _get_or_empty(cookies, "a"),
      "multiple: a")
    h.assert_eq[String val](
      "2",
      _get_or_empty(cookies, "b"),
      "multiple: b")
    h.assert_eq[String val](
      "3",
      _get_or_empty(cookies, "c"),
      "multiple: c")
