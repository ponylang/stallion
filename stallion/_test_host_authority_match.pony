  ...
  fun apply(h: TestHelper) =>
    ...
    h.assert_true(
      _HostAuthorityMatch.valid(
        "example.com",
        uri_pkg.URIAuthority(None, "example.com", None),
        "http"),
    ...
    h.assert_false(
      _HostAuthorityMatch.valid(
        "a.example",
        uri_pkg.URIAuthority(None, "b.example", None),
        "http"),
    ...
    h.assert_true(
      _HostAuthorityMatch.valid(
        "example.com",
        uri_pkg.URIAuthority(None, "example.com", U16(80)),
        "http"),
    ...
    h.assert_false(
      _HostAuthorityMatch.valid(
        "example.com",
        uri_pkg.URIAuthority(None, "example.com", U16(443)),
        no_scheme),
    ...
    h.assert_true(
      _HostAuthorityMatch.valid(
        "[::1]",
        uri_pkg.URIAuthority(None, "[::1]", None),
        no_scheme),
      "IPv6 literal match")
    h.assert_true(
      _HostAuthorityMatch.valid(
        "[2001:DB8::1]",
        uri_pkg.URIAuthority(None, "[2001:db8::1]", None),
        no_scheme),
      "IPv6 literal case-insensitive")
    h.assert_false(
      _HostAuthorityMatch.valid(
        "[::1]",
        uri_pkg.URIAuthority(None, "[::2]", None),
        no_scheme),
    ...
    h.assert_true(
      _HostAuthorityMatch.valid(
        "127.0.0.1",
        uri_pkg.URIAuthority(None, "127.0.0.1", None),
        no_scheme),
      "IPv4 match")
    h.assert_false(
      _HostAuthorityMatch.valid(
        "127.0.0.1",
        uri_pkg.URIAuthority(None, "127.000.000.001", None),
        no_scheme),
    ...
    h.assert_true(
      _HostAuthorityMatch.valid(
        "example.com:80",
        uri_pkg.URIAuthority("user", "example.com", U16(80)),
        "http"),
    ...
    h.assert_false(
      _HostAuthorityMatch.valid(
        "example.com",
        uri_pkg.URIAuthority(None, "", None),
        "http"),
    ...
    h.assert_true(
      _HostAuthorityMatch.valid(
        "a%2fb",
        uri_pkg.URIAuthority(None, "a%2Fb", None),
        no_scheme),
      "pct-encoded hex case folded (%2f == %2F)")
    h.assert_false(
      _HostAuthorityMatch.valid(
        "a%2fb",
        uri_pkg.URIAuthority(None, "a/b", None),
        no_scheme),
